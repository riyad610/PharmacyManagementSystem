...
String sql = "insert into users (ID,NAME,DOB,ADDRESS,PHONE,SALARY,PASSWORD) values ('"+id.getText()+"','"+name.getText()+"' , '"+year.getSelectedItem()+"-"+month.getSelectedItem()+"-"+day.getSelectedItem()+"' ,'"+address.getText()+"' ,'"+phone.getText()+"' ,'"+salary.getText()+"' ,'"+password.getText()+"')";
try{
