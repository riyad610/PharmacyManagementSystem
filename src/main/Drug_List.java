...
String sql3;
    ...
    private void initComponents() {
        ...
        druglist.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "         Name", "         Type", "         Barcode", "         Price", "         Expiry", "         Company", "Production_Date", "Expiration_Date"
            }
        ) {
        ...
        setSize(new java.awt.Dimension(849, 539));
...
private void drug_list(){ // this method will be executed when you click on drug_list
    String sql = "CALL str_druglist()"; // get data from database
    try{
