...
public class Pharmacy extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("9977584236");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(90, 490, 390, 29);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel8.setText("8856954223 / 8854236695");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(90, 450, 390, 29);

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setText("Bejai");
        jPanel1.add(jLabel9);
        ...
        jLabel10.setBounds(10, 550, 100, 22);
        ...
        jLabel13.setBounds(0, 74, 1220, 570);
    ...
    private void purchaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_purchaseActionPerformed
        if(!username.getText().equals("Employee")){
            ...
            String sql = "select NAME,PASSWORD from users where NAME='admin' ";
    ...
    private void warning(){
        ...
        try{
            ...
            while(res.next()){
                ...
                ex_year = Integer.parseInt(res.getString("EXPIRATION_DATE").split("-")[0]);
                ex_month = Integer.parseInt(res.getString("EXPIRATION_DATE").split("-")[1]);
                ex_day = Integer.parseInt(res.getString("EXPIRATION_DATE").split("-")[2]);
